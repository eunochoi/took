...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "scroll-fade-top": "linear-gradient(in oklch to bottom, rgb(var(--theme-surface)) 0%,  rgb(var(--theme-surface) / 0) 100%)",
        "scroll-fade-bottom": "linear-gradient(in oklch to top, rgb(var(--theme-surface)) 0%,  rgb(var(--theme-surface) / 0) 100%)",
      },
      fontFamily: {
