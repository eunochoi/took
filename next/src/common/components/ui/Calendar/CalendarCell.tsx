...
const CalendarCellComponent = <T,>({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[98%] w-[14%] flex-col items-center justify-center overflow-visible rounded-2xl border-[3px] border-transparent text-sm text-theme-text-secondary transition-opacity duration-200 ease-in-out",
