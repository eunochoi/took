...
const panelActionButtonClass = "shrink-0 rounded-2xl px-5 py-1.5 text-base shadow-card";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex w-full flex-col rounded-2xl bg-theme-surface p-4 shadow-theme-floating">
          {children}
        </div>
        {resetLabel && onReset && (
