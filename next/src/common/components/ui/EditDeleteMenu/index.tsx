  ...
  return (
    <AnimatePresence>
      {isMenuOpen && (
        ...
        >
          <button type="button" className={cn("flex items-center rounded-lg text-sm text-theme-text-primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-theme-accent", vertical && "justify-center px-3 py-2.5 hover:bg-theme-bg")} onClick={() => { closeMenu(); onEdit(); }}>
            {!vertical && <MdOutlineEdit className="mr-1 text-lg leading-none" aria-hidden="true" />}
            수정
          </button>
          <button type="button" className={cn("flex items-center rounded-lg text-sm text-theme-danger focus-visible:outline focus-visible:outline-2 focus-visible:outline-theme-accent", vertical && "justify-center px-3 py-2.5 hover:bg-theme-bg")} onClick={() => { closeMenu(); onDelete(); }}>
