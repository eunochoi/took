...
const HabitPill = ({ value, pointer = false, className, ...props }: HabitPillProps) => {
  return <span
    className={cn('bg-theme-accent/40 flex shrink-0 cursor-pointer items-center justify-center whitespace-nowrap rounded-full px-3.5 py-1 leading-[1.4] text-sm font-medium capitalize text-theme-text-primary',
