...
const HabitPill = ({ value, pointer = false, className, style, ...props }: HabitPillProps) => {
  return <span
    className={cn('bg-theme-accent/40 flex shrink-0 cursor-pointer items-center justify-center whitespace-nowrap rounded-[999px] px-3.5 py-1 leading-[1.4] text-sm font-medium capitalize text-grey-title',
