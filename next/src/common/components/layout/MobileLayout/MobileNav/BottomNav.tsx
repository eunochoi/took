...
const BottomNav = () => {
  ...
  return (
    <div className="pointer-events-none fixed bottom-0 left-0 right-0 z-[95] flex h-[var(--mobileNav)] w-full items-center justify-center">
      <nav className="pointer-events-auto flex items-center gap-1.5 px-1.5 py-1.5 rounded-[60px] bg-theme-surface-muted shadow-[0_2px_12px_rgb(var(--theme-shadow-color)/0.06)] backdrop-blur-2xl">
