...
const SettingViewTopSection = () => {
  return (
    <section>
      ...
      <Image src={bottomCat} alt="" sizes="(min-width: 1024px) 40vw, (min-width: 480px) calc(50vw - 36px), 68vw" className="ml-auto mt-auto block w-3/4 tablet:w-1/2 desktop:w-1/2" />
    </section>
  );
};
