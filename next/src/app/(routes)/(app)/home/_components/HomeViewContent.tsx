...
const HomeViewContent = ({ initialDate, selectedYear, diaryStats, habitStats }: Props) => {
  return (
    <section className={cn("grid flex-1 w-full min-w-0 grid-cols-1 items-start gap-14 desktop:grid-cols-[minmax(0,11fr)_minmax(0,9fr)] desktop:gap-x-8 desktop:gap-y-6")}>
