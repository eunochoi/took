    ...
    <article className="box-border flex w-full shrink-0 flex-col gap-4 rounded-theme bg-theme-surface p-4 shadow-theme-section">
      ...
      <div className="flex flex-col gap-3">
        ...
        >
          ...
          <span
            className="mx-1 overflow-hidden text-left text-base leading-[1.8] text-theme-text-secondary whitespace-pre-wrap break-words [display:-webkit-box] [-webkit-box-orient:vertical]"
      ...
      {diaryData.Habits.length > 0 && <DiaryHabits habits={diaryData.Habits} onHabitClick={handleHabitClick} />}
    </article>
  );
};
