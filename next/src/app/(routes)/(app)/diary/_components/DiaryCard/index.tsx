    ...
    <article className="box-border flex w-full shrink-0 flex-col gap-4 rounded-theme bg-theme-surface p-4 shadow-theme-section">
      ...
      <div className="flex flex-col gap-3">
        ...
        <button
          ...
          className="p-2 min-w-0 w-full text-left text-base leading-[1.8] text-theme-text-secondary focus-visible:outline focus-visible:outline-2 focus-visible:outline-theme-accent"
        >
          <span
