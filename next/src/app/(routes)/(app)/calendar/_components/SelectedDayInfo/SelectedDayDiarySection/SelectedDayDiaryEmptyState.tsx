...
const SelectedDayDiaryEmptyState = ({ isFuture, onAddDiary }: Props) => (
  <div className="flex w-full flex-col items-center px-2 py-6 text-center">
    {isFuture ? (
      ...
      <>
        <p className="mt-1 text-xs text-theme-text-tertiary desktop:text-sm">아직 작성한 일기가 없어요.</p>
        <p className="mt-1 text-xs text-theme-text-tertiary desktop:text-sm">하루의 이야기를 남겨보세요.</p>
