...
const infoCardClass = "grid grid-cols-[40px_1fr] gap-x-3 gap-y-1 rounded-theme border border-theme-border-muted bg-theme-surface p-5 shadow-card desktop:min-h-[150px] desktop:grid-cols-1 desktop:grid-rows-[40px_auto_1fr] desktop:gap-y-2";
