...
const LoginTopSection = () => (
  <section
    ...
    <Image src={bottomCat} alt="bottom-cat" sizes="(min-width: 1024px) 50vw, (min-width: 480px) 60vw, 68vw" className="ml-auto mt-auto block w-3/4 tablet:w-2/3 desktop:w-full" />
  </section>
);
